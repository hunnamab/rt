...
/*   Updated: 2021/02/04 21:01:37 by ldeirdre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	if (description[0][0] == '[')
	{
		while (description[i][1] != ']')
		{
			if (description[i][2] == '{')
			{
				...
				sphere->text = tex_new_bmp(get_file(description[i + 8]));
				sphere->normal_text = tex_new_bmp(get_file(description[i + 9]));
	...
	if (description[0][0] == '[')
	{
		while (description[i][1] != ']')
		{
			if (description[i][2] == '{')
			{
				...
				cylinder->text = tex_new_bmp(get_file(description[i + 9]));
				cylinder->normal_text = tex_new_bmp(get_file(description[i + 10]));
	...
	if (description[0][0] == '[')
	{
		while (description[i][1] != ']')
		{
			if (description[i][2] == '{')
			{
				...
				cone->text = tex_new_bmp(get_file(description[i + 9]));
				cone->normal_text = tex_new_bmp(get_file(description[i + 10]));
	...
	if (description[0][0] == '[')
	{
		while (description[i][1] != ']')
		{
			if (description[i][2] == '{')
			{
				...
				triangle->text = tex_new_bmp(get_file(description[i + 9]));
				triangle->normal_text = tex_new_bmp(get_file(description[i + 10]));
    ...
    if (description[0][0] == '[')
    {
        while (description[i][1] != ']')
        {
            if (description[i][2] == '{')
            {
                ...
                plane->text = tex_new_bmp(get_file(description[i + 8]));
				plane->normal_text = tex_new_bmp(get_file(description[i + 9]));
