...
/*   Updated: 2021/02/21 14:20:54 by ldeirdre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cutting_surface		new_srf(cl_float3 *param, int *obj_neg,
				cl_float param3, char *type)
{
	...
	{
		new_srf.param3 = -(new_srf.param1.x * new_srf.param2.x) -
		new_srf.param1.y * new_srf.param2.y - new_srf.param1.z
		* new_srf.param2.z;
	}
	return (new_srf);
}
...
void					get_surface(char **description,
